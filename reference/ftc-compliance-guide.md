# CAN-SPAM Act: A Compliance Guide for Business (verbatim)

**Source:** Federal Trade Commission, `ftc.gov/business-guidance/resources/can-spam-act-compliance-guide-business`. Page dated August 2023, edited January 2024 to reflect inflation-adjusted civil penalty maximums. Retrieved 2026-09-04.

**Copyright status:** A work of the United States Government. 17 U.S.C. §105 bars copyright protection for such works; the text below is public domain, reproduced in full with no permission needed.

**A note on the FTC's own numbering:** the guide states its requirements as eight bolded lead-ins, not seven. `can-spam-auditor`'s engine (`rule-map.md`) checks against the brief's 7 operative rules; the FTC's 6th header below ("Remember that subscribers and members can opt out of marketing emails, too") is the FTC's own clarifying note under the opt-out-mechanism requirement, not a separately checkable structural rule — it's reproduced here in full because the whole guide is, not because the auditor treats it as an 8th independent check. See `rule-map.md` for the actual rule-to-check mapping.
...
Sizzling Summer Special: Order by June 30th and all waterproof commercial-grade widgets are 20% off. Show us a bid from one of our competitors and we will match it. XYZ Distributing will not be undersold.
...
*`can-spam-auditor`'s `rules.md` and `rule-map.md` cite specific phrases above verbatim. See `rule-map.md` for the exact mapping.*
